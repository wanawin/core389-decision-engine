...
BUILD_MARKER = "BUILD: CORE389_LAB_APP_V1_3_2026-06-07_CORE025_PARITY_SCAFFOLD_RANK_DEPTH_RESCUE_AUDIT"
FAMILY = "Core389"
...
if not hist.empty and not sep.empty:
    ...
    hybrid_playlist=add_core025_style_rank_fields_389(playlist, hist)
    ...
    streams_scored=int(len(playlist))
    ...
    rank_guard=_rank_row_separation_report(hybrid_playlist, "Core389 v1.3 hybrid playlist")
    ...
    printable=playlist[["Core389FitRank","StreamRank","PlaylistRank","SingleRow","RowPercentile","StreamKey","SeedDateUsed","SeedResult","RecommendedPlay","Top1","Top2","Top3","Core389FitScore","PlayCount","RunningCost_25c"]].copy()
...
- v1.3 adds the Core025 parity scaffold: hybrid ranking is actually rendered/exported; rank-row guard, stream cadence, optional row cadence, TOP1/TOP2/TOP3 depth/action fields, optional Core389-only reduction/rescue rulepack hooks, and optional truth operational scoring. No 025 historical constants or embedded 025 rules are used.
""")
